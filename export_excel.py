...
def main() -> int:
    ...
    # Split by category
    categories = {
        "Certain": df[df["Category"] == "Certain"].copy() if "Category" in df.columns else pd.DataFrame(),
        "High": df[df["Category"] == "High"].copy() if "Category" in df.columns else pd.DataFrame(),
        "Medium": df[df["Category"] == "Medium"].copy() if "Category" in df.columns else pd.DataFrame(),
        "Verify": df[df["Category"] == "Verify"].copy() if "Category" in df.columns else pd.DataFrame(),
    }
